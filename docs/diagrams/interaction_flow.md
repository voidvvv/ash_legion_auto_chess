...
flowchart TD
    ...
    subgraph RUNX["局内 · 模拟域（一次远征）"]
        ...
        BATTLE -->|"判负【系统】：全灭/超时/投降 · 机会 +1<br/>三分岔（2026-08-24 机会制：败 1~2 领败箱重试 / 零棋子败回备战 / 败 3 终局）<br/>详见 defeat_chance_flow.md"| SHOPPING
...
| 原待定项 | 结论 |
|----------|------|
| `Surrender`（投降） | **保留**：战斗中随时投降，与普通判负同口径（计机会 / 给箱条件同上场 > 0 / 第 3 次即终局） |
