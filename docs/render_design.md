...
> **版本**：V1.4（RESULT 弹窗三分岔：败 1~2 败箱 / 零棋子败无箱 / 第 3 败终局；`RunEndPanel` 增 `DEFEATED` 文案位；攻击/受击动作反馈挂链 `attack_feedback_design.md`：§5.1/§5.4，像素规则新增第三例外——攻击摆动小幅旋转，§一#7/§5.3/§八#3 同步修订）  
